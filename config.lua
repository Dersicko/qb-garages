...
fullPersistence = true      --True == Reload outside vehicles at server start, false == let the outside vehicles at the impound
respawnDistance = 200              --Distance to respawn a vehicle if it's not in the world anymore
